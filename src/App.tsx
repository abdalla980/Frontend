            ...
            <Route path="/:trip/map">
                {(params) => {
                    if (params.trip === "Rathaus-Mittweida") {
                        return (
                            <Map
                                path={[[50.987346, 12.960329], [50.9867, 12.9767]]}
                                infoPage={"/RMINF"}
                            />
                        );
                        ...
                        return (
                            <Map
                                path={[[50.987346, 12.960329], [50.9853, 12.9741]]}
                                infoPage={"/AfraKirInf"}
                            />
                        );
                        ...
                        return (
                            <Map
                                path={[[50.987346, 12.960329], [50.97776, 12.96279]]}
                                infoPage={"/WasserTurm"}
                            />
                        );
                        ...
                        return (
                            <Map path={[[50.987346, 12.960329], [50.978, 12.94]]} />
                        );
                    } else if (params.trip === "Boat-Trip") {
                        return (
                            <Map
                                path={[[50.987346, 12.960329], [51.0012, 13.0125]]}
                        ...
                        return (
                            <Map
                                path={[[50.987346, 12.960329], [50.9853685, 12.9651169]]}
                        ...
                        return (
                            <Map
                                path={[[50.987346, 12.960329], [50.9863, 12.9782]]}
                                infoPage={"/Rodinainf"}
                            />
                        );
                    }
